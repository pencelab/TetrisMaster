 ...
 * 2: x, y+1        2: x-1, y       2: x, y-1       2: x+1, y
...
public final class Square extends Piece<Square> {

    private Square(final ISquareUnit[] squareUnits, final int initX, final int initY, final Color[] colors) {
        ...
        this.squareUnits[2] = new SquareUnit(initX, initY + 1, colors[2]);
        this.squareUnits[3] = new SquareUnit(initX + 1, initY + 1, colors[3]);
    }

    private Square(final ISquareUnit[] squareUnits, final byte position){
        super(squareUnits, position);
    }

    @Override
    protected Square self(final ISquareUnit[] squareUnits, final byte position) {
        return new Square(squareUnits, position);
    }
    ...
    protected ISquareUnit[] getLinkedSquareUnitsInPositionOne() {
        ...
        linkedSquareUnits[0].setLeftSquareUnit(linkedSquareUnits[2]);
        ...
        linkedSquareUnits[2].setRightSquareUnit(linkedSquareUnits[0]);
    ...
    protected ISquareUnit[] getLinkedSquareUnitsInPositionTwo() {
        ...
        linkedSquareUnits[0].setTopSquareUnit(linkedSquareUnits[2]);
        ...
        linkedSquareUnits[2].setBottomSquareUnit(linkedSquareUnits[0]);
    ...
    protected ISquareUnit[] getLinkedSquareUnitsInPositionThree() {
        ...
        linkedSquareUnits[0].setRightSquareUnit(linkedSquareUnits[2]);
        ...
        linkedSquareUnits[2].setLeftSquareUnit(linkedSquareUnits[0]);
        linkedSquareUnits[3].setLeftSquareUnit(linkedSquareUnits[1]);
        linkedSquareUnits[3].setBottomSquareUnit(linkedSquareUnits[2]);
        return linkedSquareUnits;
    }

    public static class Builder extends Piece.Builder<Square, Builder> {
        ...
        protected void setDefaults() {
            ...
            for(int i = 0; i < this.colors.length; i++)
                this.colors[i] = Globals.PieceColor.PURPLE.getColor();
        ...
        public Square build() {
            ...
            Square piece = new Square(new SquareUnit[SQUARE_UNITS], this.x, this.y, this.colors);
            for(int i = 0; i < this.position; i++){
                piece = piece.rotate();
            }
            return new Square(this.recalculateSquareUnitsCoordinates(piece), (byte) this.position);
        }
    }
