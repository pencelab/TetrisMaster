 ...
 * 1: x, y+1        1: x-1, y           1: x, y-1       1: x+1, y
 * 2: x, y+2        2: x-2, y           2: x, y-2       2: x+2, y
 * 3: x+1, y+1      3: x-1, y+1         3: x-1, y-1     3: x+1, y-1
 *
 * |---|                                    |---|
 * | 0 |                                    | 2 |
 * |---|---|        |---|---|---|       |---|---|           |---|
...
public final class T extends Piece<T> {

    private T(final ISquareUnit[] squareUnits, final int initX, final int initY, final Color[] colors) {
        super(squareUnits, (byte) 0);
        this.squareUnits[0] = new SquareUnit(initX, initY, colors[0]);
        this.squareUnits[1] = new SquareUnit(initX, initY + 1, colors[1]);
        this.squareUnits[2] = new SquareUnit(initX, initY + 2, colors[2]);
        this.squareUnits[3] = new SquareUnit(initX + 1, initY + 1, colors[3]);
    }

    private T(final ISquareUnit[] squareUnits, final byte position) {
        super(squareUnits, position);
    }

    @Override
    protected T self(final ISquareUnit[] squareUnits, final byte position) {
        return new T(squareUnits, position);
    }

    @Override
    protected ISquareUnit[] getRotatedSquareUnitsToPositionZero() {
        ISquareUnit[] squareUnits = {
                new SquareUnit(this.squareUnits[0].getX(), this.squareUnits[0].getY() - 2, this.squareUnits[0].getColor()),
                new SquareUnit(this.squareUnits[1].getX() - 1, this.squareUnits[1].getY() - 1, this.squareUnits[1].getColor()),
                new SquareUnit(this.squareUnits[2].getX() - 2, this.squareUnits[2].getY(), this.squareUnits[2].getColor()),
                new SquareUnit(this.squareUnits[3].getX(), this.squareUnits[3].getY(), this.squareUnits[3].getColor())
        };
        return squareUnits;
    }
    ...
    protected ISquareUnit[] getRotatedSquareUnitsToPositionOne() {
        ISquareUnit[] squareUnits = {
                new SquareUnit(this.squareUnits[0].getX() + 2, this.squareUnits[0].getY() + 1, this.squareUnits[0].getColor()),
    ...
    protected ISquareUnit[] getRotatedSquareUnitsToPositionTwo() {
        ISquareUnit[] squareUnits = {
                ...
                new SquareUnit(this.squareUnits[1].getX(), this.squareUnits[1].getY(), this.squareUnits[1].getColor()),
    ...
    protected ISquareUnit[] getLinkedSquareUnitsInPositionZero() {
        ...
        linkedSquareUnits[1].setRightSquareUnit(linkedSquareUnits[3]);
        linkedSquareUnits[1].setBottomSquareUnit(linkedSquareUnits[2]);
        linkedSquareUnits[2].setTopSquareUnit(linkedSquareUnits[1]);
        linkedSquareUnits[3].setLeftSquareUnit(linkedSquareUnits[1]);
    ...
    protected ISquareUnit[] getLinkedSquareUnitsInPositionOne() {
        ...
        linkedSquareUnits[1].setBottomSquareUnit(linkedSquareUnits[3]);
        linkedSquareUnits[2].setRightSquareUnit(linkedSquareUnits[1]);
        linkedSquareUnits[3].setTopSquareUnit(linkedSquareUnits[1]);
        return linkedSquareUnits;
    }
    ...
    protected ISquareUnit[] getLinkedSquareUnitsInPositionTwo() {
        ...
        linkedSquareUnits[1].setLeftSquareUnit(linkedSquareUnits[3]);
        ...
        linkedSquareUnits[3].setRightSquareUnit(linkedSquareUnits[1]);
        return linkedSquareUnits;
    }
    ...
    protected ISquareUnit[] getLinkedSquareUnitsInPositionThree() {
        ...
        linkedSquareUnits[1].setTopSquareUnit(linkedSquareUnits[3]);
        linkedSquareUnits[1].setRightSquareUnit(linkedSquareUnits[2]);
        linkedSquareUnits[2].setLeftSquareUnit(linkedSquareUnits[1]);
        linkedSquareUnits[3].setBottomSquareUnit(linkedSquareUnits[1]);
        return linkedSquareUnits;
    }

    public static class Builder extends Piece.Builder<T, Builder> {
        ...
        protected void setDefaults() {
            ...
            for(int i = 0; i < this.colors.length; i++)
                this.colors[i] = Globals.PieceColor.RED.getColor();
        ...
        public T build(){
            ...
            T piece = new T(new SquareUnit[SQUARE_UNITS], this.x, this.y, this.colors);
            for(int i = 0; i < this.position; i++){
                piece = piece.rotate();
            }
            return new T(this.recalculateSquareUnitsCoordinates(piece), (byte) this.position);
        }
    }
}
