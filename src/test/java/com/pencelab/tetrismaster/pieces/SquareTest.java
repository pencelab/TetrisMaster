...
public class SquareTest {
    ...
    @Before
    public void setUp() {
        this.piece = new Square.Builder().build();
    }
    ...
    public void shouldGetNotNullLinkedSquareUnitsInPositionZero(){
        ...
        assertEquals(squareUnits[2], ((Piece.LinkedSquareUnit)squareUnits[0]).getBottomSquareUnit());
        ...
        assertEquals(squareUnits[0], ((Piece.LinkedSquareUnit)squareUnits[2]).getTopSquareUnit());
        assertEquals(squareUnits[3], ((Piece.LinkedSquareUnit)squareUnits[2]).getRightSquareUnit());
        assertEquals(squareUnits[2], ((Piece.LinkedSquareUnit)squareUnits[3]).getLeftSquareUnit());
    ...
    public void shouldGetNotNullLinkedSquareUnitsInPositionOne(){
        ...
        assertEquals(squareUnits[2], ((Piece.LinkedSquareUnit)squareUnits[0]).getLeftSquareUnit());
        ...
        assertEquals(squareUnits[0], ((Piece.LinkedSquareUnit)squareUnits[2]).getRightSquareUnit());
        assertEquals(squareUnits[3], ((Piece.LinkedSquareUnit)squareUnits[2]).getBottomSquareUnit());
        assertEquals(squareUnits[2], ((Piece.LinkedSquareUnit)squareUnits[3]).getTopSquareUnit());
    ...
    public void shouldGetNotNullLinkedSquareUnitsInPositionTwo(){
        ...
        assertEquals(squareUnits[2], ((Piece.LinkedSquareUnit)squareUnits[0]).getTopSquareUnit());
        ...
        assertEquals(squareUnits[3], ((Piece.LinkedSquareUnit)squareUnits[2]).getLeftSquareUnit());
        assertEquals(squareUnits[0], ((Piece.LinkedSquareUnit)squareUnits[2]).getBottomSquareUnit());
        assertEquals(squareUnits[2], ((Piece.LinkedSquareUnit)squareUnits[3]).getRightSquareUnit());
    ...
    public void shouldGetNotNullLinkedSquareUnitsInPositionThree(){
        ...
        assertEquals(squareUnits[2], ((Piece.LinkedSquareUnit)squareUnits[0]).getRightSquareUnit());
        ...
        assertEquals(squareUnits[3], ((Piece.LinkedSquareUnit)squareUnits[2]).getTopSquareUnit());
        assertEquals(squareUnits[0], ((Piece.LinkedSquareUnit)squareUnits[2]).getLeftSquareUnit());
        assertEquals(squareUnits[1], ((Piece.LinkedSquareUnit)squareUnits[3]).getLeftSquareUnit());
        assertEquals(squareUnits[2], ((Piece.LinkedSquareUnit)squareUnits[3]).getBottomSquareUnit());
    }
